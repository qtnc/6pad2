...
g++ -specs=msvcr100 -o 6pad++.exe -s -O3 -w obj\*.o -luser32 -lkernel32 -lcomdlg32 -lcomctl32 -lgdi32 -lwinmm -lshlwapi -lboost-regex -L. -lUniversalSpeech -lpython34 -mthreads -mwindows -m32 -Wl,--out-implib,lib6pad++.a -DRELEASE
